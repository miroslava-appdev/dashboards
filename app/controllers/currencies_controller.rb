class CurrenciesController < ApplicationController
  ...
  def third_currency
    ...
    @new_conversions = open("https://api.exchangerate.host/convert?from=" + @from_symbol + "&to=" + @to_symbol).read
    @parsed_conversions = JSON.parse(@new_conversions)
    @info_hash = @parsed_conversions.fetch("info").fetch("rate")
